...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val ONTOLOGYURI="http://www.semanticweb.org/kdm/ontologies/2018/12/"

    val manager = OWLManager.createOWLOntologyManager
    //creating ontology manager
    val df = manager.getOWLDataFactory //In order to create objects that represent entities

    val ontology = manager.createOntology(IRI.create(ONTOLOGYURI,"drugaddiction#"))
    //Prefix for all the entities
    val pm = new DefaultPrefixManager(null, null, ONTOLOGYURI+"drugaddiction#")
    ...
    val os = new FileOutputStream("data/drugaddiction.owl")
